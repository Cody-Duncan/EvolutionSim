...
namespace EvolutionSim
{
    public interface IInputHandler 
    {
        ...
        bool KeyPressed(Keys inKey);
        bool KeyReleased(Keys inKey);
        bool KeyHold(Keys inKey);
    }
    ...
    public class InputHandler : Microsoft.Xna.Framework.GameComponent, IInputHandler
    {
        ...
        public bool KeyPressed(Keys inKey)
        {
            return keyboardState.IsKeyDown(inKey) && previousKeyboardState.IsKeyUp(inKey);
        }

        public bool KeyReleased(Keys inKey)
        {
            return keyboardState.IsKeyUp(inKey) && previousKeyboardState.IsKeyDown(inKey);
        }

        public bool KeyHold(Keys inKey)
        {
            return keyboardState.IsKeyDown(inKey) && previousKeyboardState.IsKeyDown(inKey);
        }
    }
}
